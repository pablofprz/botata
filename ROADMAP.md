...
- **Falta (fase 2):** ⚠️ validar Mastodon en vivo (instancia `botata-dev`) · vision sobre media de Mastodon · visibilidad configurable de posts/replies · schema rooms · canal Discord (abajo) · T28b providers.
