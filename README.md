...
<p align="center">
  <b>Un bot comunitario con alma de agente, para Bluesky — y el mismo motor ya habla Mastodon, Discord y WhatsApp (beta).</b><br>
  Memoria general y por usuario, tools, skills, calendario y personalidad configurable (moods, gustos y disgustos).<br>
  Conectá una API key compatible con OpenAI, creá una cuenta para el bot y configuralo para tu comunidad definiendo admin y grupos de usuarios con permisos propios.
</p>
...
Botata es un bot para comunidades en redes sociales. Vive en una cuenta de **Bluesky** (canal maduro; Mastodon, Discord y WhatsApp ya están escritos en beta, Telegram en camino), responde cuando lo mencionan, lee el feed de su comunidad, aprende de la gente con la que habla y decide por sí mismo cuándo tiene algo que decir.
...
- 🕊️ **Multi-canal** — el mismo motor detrás de cualquier red: Bluesky (maduro), Mastodon,
  Discord y WhatsApp (beta, a la espera de validación en vivo), Telegram en el roadmap.
...
> «@mi-bot ¿qué tenés apagado?» · «armate una rutina para compartir música cada 6 horas» ·
...
- **Feeds proactivos** — el bot lee el feed de la comunidad y aprende de él.
- **Rutinas** — conducta proactiva con cadencia, en archivos markdown («compartí un tema de
  jazz cada tanto», «opiná de las noticias a la mañana»).
...
pytest core/tests -q        # ~1160 tests, <40s, sin red
```

## Documentación

- [**Wiki**](docs/wiki/Home.md) — guías detalladas: instalación, configuración, personalidad,
  herramientas, memoria, canales, comandos y seguridad.
